...
import { GridPublicationsComponent } from '../common-grids/grid-publications/grid-publications.component';
import { DialogPublicationCollectionComponent } from '../common-dialog/dialog-publication-collection/dialog-publication-collection.component';
